...
public class XProjectFolderResourceMapping extends XWorkspaceElementResourceMapping {

	public XProjectFolderResourceMapping(XProjectFolderDescriptor container) {
		super(container);
	}
